/* USBSTUB-WIN32, Generic Windows USB Library
...
"\n"
"[ClassInstall]\n"
"AddReg=usbstub_class_install_add_reg\n"
"\n"
"[ClassInstall32]\n"
"AddReg=usbstub_class_install_add_reg\n"
"\n"
"[usbstub_class_install_add_reg]\n"
...
"\n"
"[DestinationDirs]\n"
"usbstub_files_sys = 10,system32\\drivers\n"
"usbstub_files_sys_x64 = 10,system32\\drivers\n"
"\n"
"[usbstub_files_sys]\n"
"usbstub.sys\n"
"\n"
"[usbstub_files_sys_x64]\n"
...
"\n"
"[USBSTUB_DEV]\n"
"CopyFiles = usbstub_files_sys"
"AddReg    = usbstub_add_reg\n"
"\n"
"[USBSTUB_DEV.NT]\n"
"CopyFiles = usbstub_files_sys"
"\n"
"[USBSTUB_DEV.NTAMD64]\n"
"CopyFiles = usbstub_files_sys_x64\n"
"\n"
"[USBSTUB_DEV.HW]\n"
"DelReg = usbstub_del_reg_hw\n"
"AddReg = usbstub_add_reg_hw\n"
"\n"
"[USBSTUB_DEV.NT.HW]\n"
"DelReg = usbstub_del_reg_hw\n"
"AddReg = usbstub_add_reg_hw\n"
"\n"
"[USBSTUB_DEV.NTAMD64.HW]\n"
"DelReg = usbstub_del_reg_hw\n"
"AddReg = usbstub_add_reg_hw\n"
"\n"
"[USBSTUB_DEV.NT.Services]\n"
"AddService = usbstub, 0x00000002, usbstub_add_service\n"
"\n"
"[USBSTUB_DEV.NTAMD64.Services]\n"
"AddService = usbstub, 0x00000002, usbstub_add_service\n"
"\n"
"[usbstub_add_reg]\n"
"HKR,,DevLoader,,*ntkern\n"
"HKR,,NTMPDriver,,usbstub.sys\n"
"\n"
...
static int save_file(HWND dialog, device_context_t *device)
{
	...
	if (GetSaveFileName(&open_file)) {
		...
		if (file) {
			...
			fprintf(file, "\"%s\"=USBSTUB_DEV, USB\\VID_%04x&PID_%04x\n\n", 
				device->description,
