...
build_test()
{
	...
	if [ "x${TEST_EARLY}" = "xlitmus" ]; then
		build_litmus
		echo "#!/bin/sh" > ${EARLY_TEST}
		if [ "x${TEST_LITMUS}" = "xpostsil" ]; then
			...
			# TODO: automatically generates according to the cache sizes
			# L1: 16KB, L2: 256KB, L3: 2MB configuration
			echo "echo \"Running test 0 out of 3\"" >> ${EARLY_TEST}
			echo "litmus -st 1 -s 8k -r 32" >> ${EARLY_TEST}
			echo "echo \"Running test 1 out of 3\"" >> ${EARLY_TEST}
			echo "litmus -st 1 -s 128k -r 16" >> ${EARLY_TEST}
			echo "echo \"Running test 2 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 1 -s 4M -r 8" >> ${EARLY_TEST}
			echo "echo \"Running test 3 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 2 -s 8k -r 16" >> ${EARLY_TEST}
			echo "echo \"Running test 4 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 2 -s 126k -r 8" >> ${EARLY_TEST}
			echo "echo \"Running test 5 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 2 -s 4M -r 4" >> ${EARLY_TEST}
			echo "echo \"Running test 6 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 4 -s 8k -r 8" >> ${EARLY_TEST}
			echo "echo \"Running test 7 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 4 -s 128k -r 4" >> ${EARLY_TEST}
			echo "echo \"Running test 8 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 4 -s 4M -r 2" >> ${EARLY_TEST}
			echo "echo \"Running test 9 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 8 -s 8k -r 4" >> ${EARLY_TEST}
			echo "echo \"Running test 10 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 8 -s 128k -r 2" >> ${EARLY_TEST}
			echo "echo \"Running test 11 out of 60\"" >> ${EARLY_TEST}
			echo "litmus -st 8 -s 4M -r 1" >> ${EARLY_TEST}
		fi
	fi
