...
byte_t *iso14443a_locate_historical_bytes(byte_t *pbtAts,
					  size_t szAts,
					  size_t *pszTk)
{
	if (szAts) {
 ...
 */
void iso14443_cascade_uid(const byte_t abtUID[], const size_t szUID,
			  byte_t *pbtCascadedUID, size_t *pszCascadedUID)
{
	switch (szUID) { 
	case 7: 
