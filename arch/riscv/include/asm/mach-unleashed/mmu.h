...
#define FIX_UART		(FIX_HOLE + 6)
#define FIX_L2_CC		(FIX_HOLE + 7)
#define FIX_DDRC		(FIX_HOLE + 8)
#define FIX_QSPI0		(FIX_HOLE + 9)
#define FIX_QSPI1		(FIX_HOLE + 10)
#define FIX_QSPI2		(FIX_HOLE + 11)
