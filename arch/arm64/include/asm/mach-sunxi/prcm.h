#ifndef __PRCM_SUNXI_H_INCLUDE__
#define __PRCM_SUNXI_H_INCLUDE__
...
struct __packed sunxi_prcm_reg {
	...
	uint32_t apb0_ratio;		/* 0x00c */
	uint32_t cpu0_cfg;		/* 0x010 */
	uint32_t cpu1_cfg;		/* 0x014 */
	uint32_t cpu2_cfg;		/* 0x018 */
	uint32_t cpu3_cfg;		/* 0x01c */
	uint8_t res1[0x8];		/* 0x020 */
	uint32_t apb0_gate;		/* 0x028 */
	uint8_t res2[0x14];		/* 0x02c */
	uint32_t pll_ctrl0;		/* 0x040 */
	uint32_t pll_ctrl1;		/* 0x044 */
	uint8_t res3[0x8];		/* 0x048 */
	uint32_t clk_1wire;		/* 0x050 */
	uint32_t clk_ir;		/* 0x054 */
	uint8_t res4[0x58];		/* 0x058 */
	uint32_t apb0_reset;		/* 0x0b0 */
	uint8_t res5[0x3c];		/* 0x0b4 */
	uint32_t clk_outd;		/* 0x0f0 */
	uint8_t res6[0xc];		/* 0x0f4 */
	uint32_t cpu_pwroff;		/* 0x100 */
	uint8_t res7[0xc];		/* 0x104 */
	uint32_t vdd_sys_pwroff;	/* 0x110 */
	uint8_t res8[0x4];		/* 0x114 */
	uint32_t gpu_pwroff;		/* 0x118 */
	uint8_t res9[0x4];		/* 0x11c */
	uint32_t vdd_pwr_reset;	/* 0x120 */
	uint8_t res10[0x1c];		/* 0x124 */
	uint32_t cpu_pwr_clamp[4];	/* 0x140 but first one is actually unused */
	uint8_t res11[0x30];		/* 0x150 */
	uint32_t dram_pwr;		/* 0x180 */
	uint8_t res12[0xc];		/* 0x184 */
	uint32_t dram_tst;		/* 0x190 */
	uint8_t res13[0x3c];		/* 0x194 */
	uint32_t prcm_sec_switch;	/* 0x1d0 */
};

void prcm_apb0_enable(uint32_t flags);
void prcm_apb0_disable(uint32_t flags);

#endif /* __ASSEMBLY__ */

#endif /*__PRCM_SUNXI_H_INCLUDE__ */
