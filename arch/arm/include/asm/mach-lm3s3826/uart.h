#ifndef __UART_LM3S3826_H_INCLUDE__
#define __UART_LM3S3826_H_INCLUDE__

#include <asm/mach/usart.h>

#ifdef CONFIG_UART_LM3S3826
...
#ifdef CONFIG_UART_LM3S3826_UART1_PA0
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART1_PB0
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART1_PB4
#define __UART1_HW_DEV_GPIO	DEV_GPIOB
#define __UART1_HW_RX_PORT	GPIOB
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART1_PC6
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART1_PD0
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART1_PD2
#define __UART1_HW_DEV_GPIO	DEV_GPIOD
#define __UART1_HW_RX_PORT	GPIOD
...
#ifdef CONFIG_UART_LM3S3826_UART2_PD0
...
#endif
#ifdef CONFIG_UART_LM3S3826_UART2_PB4
#define __UART2_HW_DEV_GPIO	DEV_GPIOB
#define __UART2_HW_RX_PORT	GPIOB
#define __UART2_HW_RX_PIN	4
#define __UART2_HW_RX_MUX	GPIOE4_MUX_U2RX
#define __UART2_HW_TX_PORT	GPIOE
#define __UART2_HW_TX_PIN	4
...
#endif /* __UART_LM3S3826_H_INCLUDE__ */
