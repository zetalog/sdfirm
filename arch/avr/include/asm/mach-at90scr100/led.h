#ifndef __LED_AT90SCR100_H_INCLUDE__
#define __LED_AT90SCR100_H_INCLUDE__
...
#ifdef CONFIG_LED_AT90SCR100_MAX_LIGHTS
#define NR_LED_HW_LIGHTS	CONFIG_LED_AT90SCR100_MAX_LIGHTS
#else
#define NR_LED_HW_LIGHTS	4
#endif
#ifdef CONFIG_LED_AT90SCR100_MAX_COLORS
#define NR_LED_HW_COLORS	CONFIG_LED_AT90SCR100_MAX_COLORS
#else
...
#endif /* __LED_AT90SCR100_H_INCLUDE__ */
