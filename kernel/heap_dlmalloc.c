...
#define heap_request_pad(req)						\
	((heap_offset_t)((req) + HEAP_SIZE_SIZE + HEAP_ALIGN_MASK) <	\
	 (heap_offset_t)(HEAP_HEAD_SIZE + HEAP_ALIGN_MASK) ?		\
	 HEAP_HEAD_SIZE :						\
	 ALIGN((req) + HEAP_SIZE_SIZE, HEAP_ALIGN_SIZE))
