...
/* 8.9 LPC_ADDR */
#define LPC_ADDR_OFFSET				0
#define LPC_ADDR_MASK				REG_32BIT_MASK
#define LPC_ADDR(value)				_SET_FV(LPC_ADDR, value)

/* 8.10 LPC_WDATA */
#define LPC_WDATA_OFFSET			0
#define LPC_WDATA_MASK				REG_32BIT_MASK
#define LPC_WDATA(value)			_SET_FV(LPC_WDATA, value)

/* 8.11 LPC_RDATA */
#define LPC_RDATA_OFFSET			0
#define LPC_RDATA_MASK				REG_32BIT_MASK
#define LPC_RDATA(value)			_GET_FV(LPC_RDATA, value)
...
#define SERIRQ_SLOT_MASK_OFFSET			REG32_1BIT_OFFSET(n)
#define SERIRQ_SLOT_MASK_MASK			REG_1BIT_MASK
#define SERIRQ_SLOT_MASK(n, value)		_SET_FVn(n, SERIRQ_SLOT_MASK, value)

/* 8.16 SERIRQ_SLOT_IRQ */
#define SERIRQ_SLOT_IRQ_OFFSET			REG32_1BIT_OFFSET(n)
#define SERIRQ_SLOT_IRQ_MASK			REG_1BIT_MASK
#define SERIRQ_SLOT_IRQ(n, value)		_GET_FVn(n, SERIRQ_SLOT_IRQ, value)

/* 8.17 SERIRQ_SLOT_CLR */
#define SERIRQ_SLOT_CLR_OFFSET			REG32_1BIT_OFFSET(n)
#define SERIRQ_SLOT_CLR_MASK			REG_1BIT_MASK
#define SERIRQ_SLOT_CLR(n, value)		_SET_FVn(n, SERIRQ_SLOT_CLR, value)
