...
#define PORT_RESOURCE_CON_REG_VC0	0x15C
#define PORT_VC_ENABLE_VC0		_BV(31)
#define PORT_VC_TC_MAP_VC0_BIT1_MASK	GENMASK(7, 0)
#define PORT_VC_TC_MAP_VC0_BIT1(n)	FIELD_PREP(PORT_VC_TC_MAP_VC0_BIT1_MASK, n)

#define PORT_RESOURCE_STATUS_REG_VC0	0x160
#define PORT_RESOURCE_STATUS_REG_VC1	0x16C

#define PORT_RESOURCE_CAP_REG_VC1		0x168
#define PORT_VC_PORT_ARBI_TABLE_VC1_MASK	GENMASK(31, 24)
#define PORT_VC_PORT_ARBI_TABLE_VC1(n)		FIELD_PREP(PORT_VC_PORT_ARBI_TABLE_VC1_MASK, n)
#define PORT_VC_PORT_ARBI_CAP_VC1_MASK		GENMASK(7, 0)
#define PORT_VC_PORT_ARBI_CAP_VC1(n)		FIELD_PREP(PORT_VC_PORT_ARBI_CAP_VC1_MASK, n)
...
#define PORT_LINK_RATE_MASK		GENMASK(11, 8)
#define PORT_LINK_RATE(n)		FIELD_PREP(PORT_LINK_RATE_MASK, n)
#define PORT_FASK_LINK_MODE_ENABLE	_BV(7)
#define PORT_DLL_LINK_ENABLE		_BV(5)
...
#define PCIE_PORT_DEBUG1_LINK_UP		_BV(4)
#define PCIE_PORT_DEBUG1_LINK_IN_TRAINING	_BV(29)

#define PCIE_LINK_WIDTH_SPEED_CONTROL	0x80C
#define PORT_LOGIC_SPEED_CHANGE		_BV(17)
...
#define PCIE_ATU_REGION_INBOUND		_BV(31)
...
#define PCIE_DBI_RO_WR_EN		_BV(0)

#define PCIE_PL_CHK_REG_CONTROL_STATUS			0xB20
#define PCIE_PL_CHK_REG_CHK_REG_START			_BV(0)
#define PCIE_PL_CHK_REG_CHK_REG_CONTINUOUS		_BV(1)
#define PCIE_PL_CHK_REG_CHK_REG_COMPARISON_ERROR	_BV(16)
#define PCIE_PL_CHK_REG_CHK_REG_LOGIC_ERROR		_BV(17)
#define PCIE_PL_CHK_REG_CHK_REG_COMPLETE		_BV(18)
