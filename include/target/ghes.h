...
/**
 * ghes_estatus_node_alloc - Allocate error status block
 * @return: Pointer to allocated error status block
 */
struct acpi_hest_generic_status *ghes_estatus_node_alloc(void);

/**
 * ghes_estatus_queue - Queue error status for processing
 * @estatus: Pointer to error status block
 */
void ghes_estatus_queue(struct acpi_hest_generic_status *estatus);
...
static inline struct acpi_hest_generic_status *ghes_estatus_node_alloc(void) { return NULL; }

static inline void ghes_estatus_queue(struct acpi_hest_generic_status *estatus) { return; }
#endif
