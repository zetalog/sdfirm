...
#define MMC_DEBUG_CMD		MMC_DEBUG_BASE+1
#define MMC_DEBUG_ERROR		MMC_DEBUG_BASE+2
#define MMC_DEBUG_EVENT		MMC_DEBUG_BASE+3
#define MMC_DEBUG_STATE		MMC_DEBUG_BASE+4
