#ifndef __LIBUSB_H_INCLUDE__
#define __LIBUSB_H_INCLUDE__
...
int libusb_get_configuration(libusb_device_handle *dev, uint8_t *config);
...
int libusb_set_configuration(libusb_device_handle *dev, uint8_t configuration);
...
int libusb_get_string_descriptor_ascii(libusb_device_handle *dev, uint8_t index,
