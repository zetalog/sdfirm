...
void ccn512_join_snoop_domain(uint64_t base, uint64_t rqf_nid_bitmap, uint8_t hnf_idx)
{
	uint64_t *hnf_snoop_set_addr = (uint64_t *)get_hnf_snoop_set_addr(base, hnf_idx);
