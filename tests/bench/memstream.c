...
#ifdef CONFIG_MEMSTREAM_ARRAY_SIZE
#define STREAM_ARRAY_SIZE	CONFIG_MEMSTREAM_ARRAY_SIZE
#endif
#ifdef CONFIG_MEMSTREAM_NTIMES
#define NTIMES CONFIG_MEMSTREAM_NTIMES
#endif

struct memstream_percpu {
	struct memstream_context *ptr;
} __cache_aligned;
static struct memstream_percpu memstream_ctx[MAX_CPU_NUM];
 ...
 */
#ifndef CONFIG_MEMSTREAM_NTIMES
#ifdef NTIMES
#if NTIMES<=1
#   define NTIMES	10
#endif
...
void main ()
#else
int memstream(caddr_t percpu_area)
#endif
    {
#ifdef CONFIG_MEMSTREAM_TIME_ON
...
__define_testfn(memstream, sizeof(struct memstream_context), SMP_CACHE_BYTES,
