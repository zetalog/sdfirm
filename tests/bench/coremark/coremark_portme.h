...
#ifdef CONFIG_COREMARK_USE_CLOCK
#define USE_CLOCK 1
...
#endif
#ifndef CONFIG_COREMARK_CFLAGS_STR
#define CONFIG_COREMARK_CFLAGS_STR "TODO"
#endif
...
typedef tick_t CORE_TICKS;
typedef tick_t clock_t;
#else
...
*/
 ...
 #define COMPILER_FLAGS CONFIG_COREMARK_CFLAGS_STR
#endif
#ifndef MEM_LOCATION 
